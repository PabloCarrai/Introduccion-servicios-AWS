# Resumen Detallado de Unidad 3: Servicios de Cómputo en AWS

Este documento contiene el resumen detallado sobre los servicios de cómputo de AWS: EC2, Contenedores (ECS y Fargate) y Serverless (Lambda).
...
- **Gateway Load Balancer (GWLB):** Diseñado para desplegar, escalar y gestionar dispositivos virtuales de terceros (como firewalls o sistemas de prevención de intros).
...
- Aislamiento nativo por tarea a nivel de kernel, proporcionando una seguridad robusta por diseño.
